<div id="members">
	...
	<div id="ayan" class="member">
		<div class="face"><img src="css/img/people/ayan.jpg"></div>
		<div class="data">
			<h2 class="name"><a href="https://facebook.com/ayu.ark">Ayan Chandra</a></h2><div class="tags"><a class="committeeGuy">Committee</a><a class="representativeGuy">Representative</a></div>
			<h3 class="oneline">Open Source Enthusiast and Bio-researcher.</h3>
			<h4 class="edu">Studies at West Bengal University of Technology, Salt Lake</h4>
			<h4 class="extraedu">B. Tech. CSE, 3rd year</h4>
			<p class="about">The senior personally guiding Ranodeep.</p>
		</div>
	</div>
	<div id="sagnik" class="member">
		...
		<div class="data">
			...
			<h4 class="edu">Studies at West Bengal University of Technology, Salt Lake</h4>
			<h4 class="extraedu">B. Tech. CSE, 2nd year</h4>
			<p class="about">The guy responsible for most of the textual content and some of the imagery and other legwork.</p>
		</div>
	</div>
	<div id="priyansu" class="member">
		<div class="face"><img src="css/img/people/priyansu.jpg"></div>
		<div class="data">
			<h2 class="name"><a href="https://facebook.com/priyansu.ganguly">Priyansu Ganguly</a></h2><div class="tags"><a class="committeeGuy">Committee</a></div>
			<h3 class="oneline">Open Source Enthusiast.</h3>
			<h4 class="edu">Studies at West Bengal University of Technology, Salt Lake</h4>
			<h4 class="extraedu">B. Tech. CSE, 1st year</h4>
			<p class="about">The guy who supported Ranodeep personally.</p>
		</div>
	</div>
</div>