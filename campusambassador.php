...
<body>
	<div class="campamb">
		...
		b) Forwarding the mails to their student mailing list.<br>
		c) Publicizing our events on their social media channels by sharing the link of our event.<br>
		Coordinate with your and other colleges to create awareness on Konstruct 2015 website and the events </p><br>
		<p class="Q">ADVANTAGES OF BEING A CAMPUS AMBASSADOR INCLUDE</p>
		<p class="A">a) Opportunity to collaborate with, and be a part of a network.<br>
		b) Gain exposure in a first of its kind event promotion, organization and brand management.<br><br>
		<a href="mainsite.php"><button>Return to apply</button></a>
	</div>
